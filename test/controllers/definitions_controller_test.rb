...
class DefinitionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create definition" do
    assert_difference('Definition.count') do
      post definitions_url, params: { definition: { definition: @definition.definition, example: @definition.example, user_id: @definition.user_id, word_id: @definition.word_id } }
    end
  ...
  test "should update definition" do
    patch definition_url(@definition), params: { definition: { definition: @definition.definition, example: @definition.example, user_id: @definition.user_id, word_id: @definition.word_id } }
